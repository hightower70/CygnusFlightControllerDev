...
//#define _halEnableGPIOClock(port) __GPIO##port##_CLK_ENABLE()
//#define halEnableGPIOClock(port) _halEnableGPIOClock(port)

//#define _halGPIO(port) GPIO##port
//#define halGPIO(port) _halGPIO(port)


//#define _halSPI(index) SPI ## index
//#define halSPI(index) _halSPI(index)

//#define _halEnableSPIClock(index) __SPI ## index ## _CLK_ENABLE()
//#define halEnableSPIClock(index) _halEnableSPIClock(index)
