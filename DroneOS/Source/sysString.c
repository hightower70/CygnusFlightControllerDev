...
{
	return sysCopyConstString( in_destination, in_destination_size, sysGetStringLength( in_destination ), in_source );
}
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Fills string buffer with a specified character
/// @param in_destination Destination buffer
/// @param in_destination_size Size of the destination buffer
/// @param in_start_pos Character position where filling will start
/// @param in_required_length Number of the characters stored
/// @return Position of the end of the string in the destination buffer
...
/////////////////////////////////////////////////////////////////////////////////
//// Convert from Unicode character to sysChar
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Converts 16 bit unisgned value value to string
/// @param in_destination Destination buffer
/// @param in_destination_size Size of the destination buffer
/// @param in_start_pos Character position where conversion result will be stored
/// @param in_value Value to convert
/// @param in_field_length Field with where the conversion result will be stored (0 - left justified output, field width not used)
/// @param in_precision Number of fractional digits
/// @param in_options Conversion options (see: strSCO_xxx definitions)
sysStringLength sysWordToStringPos( sysString in_buffer, sysStringLength in_buffer_length, sysStringLength in_pos, uint16_t in_value, uint8_t in_field_length, uint8_t in_precision, uint8_t in_options )
{
	...
	if( (in_options & sysSCO_DISPLAY_MINUS_SIGN) != 0 )
	...
	while( divisor > 0 && (buffer_index - in_pos) < field_length )
	{
		...
		if( (digit != 0 || !zero_blank || (divisor == 1) ||
				((in_options & sysSCO_NO_ZERO_BLANKING) != 0 && digit_index <= field_length)) && ((buffer_index - in_pos) < field_length) )
		{
	...
	{
		sysFillString( in_buffer, in_buffer_length, '#', in_pos, in_pos + field_length );
...
/////////////////////////////////////////////////////////////////////////////////
//// DWord to string
//void strDWordToString( sysString in_buffer, sysStringLength in_buffer_length, dosDWord in_value, uint8_t in_field_length, uint8_t in_precision, uint8_t in_options )
//{
...
/////////////////////////////////////////////////////////////////////////////////
//// DWord to string pos
//sysStringLength strDWordToStringPos( sysString in_buffer, sysStringLength in_buffer_length, sysStringLength in_pos, dosDWord in_value, uint8_t in_field_length, uint8_t in_precision, uint8_t in_options )
//{
//	bool zero_blank = true;
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Adjust string buffer
static void strConversionAdjustBuffer( sysString in_buffer, sysStringLength in_buffer_length, sysStringLength in_pos, sysStringLength in_field_length, uint8_t in_options, sysStringLength in_buffer_index )
{
	sysStringLength digit_index;
	
	// right adjustment
	if( (in_options & sysSCO_RIGHT_ADJUSTMENT) != 0 )
	{
...
//sysStringLength strDWordToHexStringPos( sysString in_buffer, sysStringLength in_buffer_length, sysStringLength in_pos, dosDWord in_value )
//{
...
{
	for( ;  sysCharToUpper(*in_string1) == sysCharToUpper(*in_string2); in_string1++, in_string2++)
	{
		if(*in_string1 == '\0')
			return 0;
	}
	return ((sysCharToUpper(*in_string1) < sysCharToUpper(*in_string2)) ? -1 : +1);
}
...
//int strCheckForTokenNoCase(sysString in_buffer, sysStringLength in_buffer_length, sysStringLength* inout_index, bool* in_success, rtosConstString in_expected_tokens[])
//{
//	int token_index;
...
//void strCheckForConstStringNoCase(sysString in_buffer, sysStringLength in_buffer_length, sysStringLength* inout_index, bool* in_success, rtosConstString in_string )
//{
//	bool success = true;
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Check for a const string at the given position
/// @param in_buffer Buffer conatining the string to check in
/// @param in_buffer_length Total length of the buffer (in haracters)
/// @param inout_index Pointer to the index within the buffer
/// @param inout_success Pointer to the result
/// @param in_string Constants string to search for
void sysCheckForConstString(sysString in_buffer, sysStringLength in_buffer_length, sysStringLength* inout_index, bool* inout_success, sysConstString in_string )
{
	...
	while( index < in_buffer_length && in_buffer[index] != '\0' && *in_string != '\0' && success )
	{
...
void sysStringToByte( sysString in_buffer, sysStringLength in_buffer_length, sysStringLength* in_index, bool* in_success, uint8_t* out_number )
{
	...
	// convert to word
	sysStringToWord( in_buffer, in_buffer_length, in_index, in_success, &number );
...
//void strStringToDWord( sysString in_buffer, sysStringLength in_buffer_length, sysStringLength* in_index, bool* in_success, dosDWord* out_number )
//{
//	uint8_t digits = 0;
//	uint8_t dig;
//
...
//void strStringToFixedDWord( sysString in_buffer, sysStringLength* in_index, bool* in_success, dosDWord* out_number, uint8_t in_fixed_point, dosDWord in_divisor )
//{
//	uint8_t digits;
//	uint8_t dig;
//	uint8_t dot_pos = 0xff;
...
///// @param Pointer to the result status code variable (true - success, false - failed)
///// @param Output value
//void strHexStringToDWord( sysString in_buffer, sysStringLength in_buffer_length, sysStringLength* in_index, bool* in_success, dosDWord* out_number )
//{
//	uint8_t digits;
//
//	// sanity check
...
sysStringLength sysStringPrintf(sysString in_destination, sysStringLength in_destination_size, sysStringLength in_pos, sysConstString in_format, ...)
{
	...
	retval = snprintf(in_destination + in_pos, in_destination_size, in_format, argptr );

	va_end(argptr);

	return retval + in_pos;
}
